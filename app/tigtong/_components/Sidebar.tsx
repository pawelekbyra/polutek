...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const {
    ...
    setActiveContentId: state.setActiveContentId,
  ...
  return (
    ...
    >
      ...
      {/* Tip Jar (Custom SVG) */}
      <button onClick={() => openTippingModal({ contentId: slideId })} data-action="show-tip-jar" className={buttonClass + " mt-2"}>
