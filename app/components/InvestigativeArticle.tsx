...
import { ArrestVideo, StefanekVideo, KicinskiVideo } from './InvestigativeMedia';

interface InvestigativeArticleProps {
  onOpenGallery: () => void;
}

export const InvestigativeArticle: React.FC<InvestigativeArticleProps> = ({ onOpenGallery }) => {
  return (
    <article className="max-w-3xl mx-auto px-6 pt-4 pb-0 flex-grow w-full z-10 relative">
      ...
      >
        ...
        <p className="mt-4">
          Pobrany dokument nie pozostawia wątpliwości: w latach 2012–2023 współwłaścicielami ayahuaskowej nieruchomości byli:
          <br/><br/>
        ...
        <p className="mt-4">
          Na mocy wyroku z dnia 2 listopada 2021 roku
          <button
            onClick={onOpenGallery}
            className="inline-flex items-center justify-center ml-2 cursor-pointer hover:bg-[#e8d154]/50 transition-colors rounded px-1 text-2xl align-middle"
            title="Kliknij, aby zobaczyć wyrok Bartosza Badowskiego"
          >
            📄
          </button>
          Bartosz Badowski został uznany winnym popełnienia zbrodni niedozwolonej produkcji i innego obchodzenia się ze środkami odurzającymi.
        </p>
