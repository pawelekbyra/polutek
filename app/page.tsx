        ...
        <div className="w-full max-w-4xl bg-paper-texture flex flex-col items-center pb-20 border-x-2 border-ink overflow-hidden">
          ...
          <div className="w-full flex flex-col items-center pt-1 pb-1">
            <div className="flex items-center justify-center w-[calc(100%-2rem)] mx-auto gap-4 pt-2 pb-1">
              ...
              <h1 className="font-unifraktur font-black uppercase text-4xl md:text-[4.5rem] text-ink tracking-tighter leading-none whitespace-nowrap px-2">
                NASZA GAZETKA
              </h1>
              <div className="flex-grow h-[2px] bg-ink"></div>
            </div>
          ...
          <article className="max-w-3xl mx-auto px-6 pt-4 pb-0 flex-grow w-full z-10 relative">
            <div className="article-prose">
              ...
              <div className="my-12 flex flex-col items-center">
                <a href={`${KORDYS_IMAGES_URL}/wezwanie/wezwanie_kicinski.png`} target="_blank" rel="noreferrer">
                  <img
              ...
              <div className="grid gap-4 text-sm text-ink-medium">
                <div className="source-card">
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                    ...
                    <a href={KORDYS_PDF_URL} target="_blank" rel="noreferrer" className="shrink-0 w-40 justify-center bg-[#e8d154]/20 text-ink px-3 py-1 text-xs font-bold rounded border border-[#8b7312]/40 hover:bg-[#e8d154]/40 transition-colors flex items-center gap-2 underline">
                      <span>📄</span> PDF
                    </a>
                  </div>
                </div>
