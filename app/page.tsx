    ...
    <ElixirModalsProvider>
      ...
      <main className="min-h-screen bg-[#e4dbbe] text-[#1c1917] selection:bg-[#722f37]/20 font-serif flex flex-col items-center">
        <div className="w-full max-w-5xl bg-[#e4dbbe] min-h-screen shadow-2xl border-x-[2px] border-[#3d2b1f] flex flex-col relative overflow-hidden">
          ...
          <header className="pt-8 pb-8 px-4 z-10 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="max-w-2xl mx-auto border-y border-[#c4b99a] py-8 px-4">
          ...
          <article className="max-w-2xl mx-auto px-4 pt-8 pb-0 flex-grow z-10 relative">
            <div className="prose prose-stone prose-lg max-w-none prose-headings:font-sans prose-headings:font-bold prose-blockquote:not-italic
              ...
              <p className="first-letter:text-7xl first-letter:font-bold first-letter:mr-3 first-letter:float-left first-letter:text-[#722f37] leading-relaxed mt-0">
              ...
              <div className="my-12 pl-6 border-l-[3px] border-[#722f37]/80 font-serif italic text-xl text-[#3d2b1f]">
              ...
              <h2 className="text-3xl mt-16 mb-8 tracking-tight text-[#3d2b1f] border-b border-[#722f37]/40 pb-2">Cena wolności</h2>
              ...
              <div className="my-12 w-full rounded-sm overflow-hidden shadow-md">
               ...
               <div className="mt-1 text-sm text-[#8a7a62] font-sans border-l-2 border-[#c4b99a] pl-3 mb-12">
              ...
              <div className="my-12 flex gap-4 p-5 bg-[#faf6ec]/80 border-l-4 border-[#722f37] rounded-r-lg shadow-sm">
                <Scale className="w-8 h-8 text-[#722f37] shrink-0 mt-1" />
                <div>
              ...
              <p>
                 Na mocy <GalleryTrigger type="wyrok_badi" className="font-bold text-[#722f37] underline decoration-double decoration-[#b8a880] hover:bg-[#e8e0cc] transition-colors">wyroku</GalleryTrigger> z dnia 2 listopada 2021 roku Bartosz Badowski został uznany winnym popełnienia &quot;zbrodni niedozwolonej produkcji i innego obchodzenia się ze środkami odurzającymi&quot;.
              </p>
              ...
              <h2 className="text-3xl mt-16 mb-8 tracking-tight text-[#3d2b1f] border-b border-[#722f37]/40 pb-2">Cisza po burzy</h2>
              ...
              <h2 className="text-3xl mt-16 mb-8 tracking-tight text-[#3d2b1f] border-b border-[#722f37]/40 pb-2">&quot;Błąd z Badim&quot;</h2>
              ...
              <div className="my-12 flex flex-col items-center">
                <GalleryTrigger type="wezwanie_kicinski">
                  <img
                    ...
                    className="w-48 rounded shadow-md border border-[#c4b99a] cursor-pointer hover:opacity-90 transition-opacity"
                  />
                </GalleryTrigger>
                <p className="text-xs text-[#8a7a62] mt-2 font-mono uppercase tracking-wider w-48 text-center">
              ...
              <CaseFile title="Odpowiedź na pytanie o udział">
                &quot;nie brałem udziału w takich ceremoniach w latach 2016-2023, a o wcześniejszym okresie <span className="underline decoration-[#722f37] decoration-4 underline-offset-4 font-bold">odmawiam odpowiedzi</span>&quot;
              </CaseFile>
              ...
              <h2 className="text-3xl mt-16 mb-8 tracking-tight text-[#3d2b1f] border-b border-[#722f37]/40 pb-2">Anonimowy filantrop</h2>
              ...
              <CaseFile title="Wypowiedź K. Stefanka">
                &quot;Ostatecznie <span className="bg-[#722f37] px-1 font-bold text-[#faf6ec] box-decoration-clone">23 października 2023 roku</span> ten człowiek do nas zadzwonił powiedział, że wspólnie z żoną zdecydowali, że oni by chcieli to miejsce przekazać w darowiźnie&quot;
              </CaseFile>
              ...
              <ul className="list-none space-y-12 my-12 font-mono text-sm border-l-2 border-[#c4b99a] pl-4">
                <li className="flex items-start gap-3">
                  <Calendar className="w-5 h-5 text-[#b8a880] shrink-0" />
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <Calendar className="w-5 h-5 text-[#722f37] shrink-0 mt-3" />
                  <div className="bg-[#faf6ec] border border-[#c4b99a] p-4 rounded-sm shadow-sm w-full relative overflow-hidden">
              ...
              <h2 className="text-3xl mt-16 mb-8 tracking-tight text-[#3d2b1f] border-b border-[#722f37]/40 pb-2">Nýdek</h2>
              ...
              <p>
                <span className="bg-[#722f37] px-1 font-bold text-[#faf6ec] shadow-sm">Oznacza to, że nie jeden lecz obaj legendarni założyciele CD Projekt, na czeskim pograniczu posiadali nieruchomości, w których odpłatnie oferowano te same nielegalne substancje.</span>
              </p>
              ...
              <div className="mt-8 mb-4 flex justify-end">
                 <div className="text-right">
                    ...
                    <span className="block text-xs text-[#8a7a62] font-sans mt-1 italic">detektyw.polutek@protonmail.com</span>
                 </div>
              </div>
              ...
              <div className="my-12 border-y-2 border-[#3d2b1f] py-8">
                 ...
                 <div className="grid gap-px bg-[#c4b99a] border border-[#c4b99a]">
                    <div className="bg-[#f5f0e1] p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                          <span className="block font-serif text-[#3d2b1f] font-medium">Śledztwo w sprawie organizacji ceremonii</span>
                          <span className="block text-xs text-[#8a7a62] mt-1">Prokuratura Rejonowa w Częstochowie</span>
                        </div>
                        <span className="font-mono text-xs font-bold bg-[#e8e0cc] px-3 py-1.5 border border-[#c4b99a] text-[#5a4a3a] rounded-sm shadow-sm whitespace-nowrap">
                          3013-1.Ds.15.2024
                        </span>
                    </div>
                    ...
                    <div className="bg-[#f5f0e1] p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <span className="font-mono text-xs font-bold bg-[#722f37]/10 px-3 py-1.5 border border-[#722f37]/30 text-[#722f37] rounded-sm shadow-sm whitespace-nowrap">
                          3013-1.Ds.4.2026
                        </span>
                    </div>
                    ...
                    <div className="bg-[#f5f0e1] p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                          ...
                          <span className="block text-xs text-[#8a7a62] mt-1">Prokuratura Rejonowa w Pułtusku</span>
                        </div>
                        <div className="flex flex-col items-end gap-1">
                          <span className="font-mono text-xs font-bold bg-[#e8e0cc] px-3 py-1.5 border border-[#c4b99a] text-[#5a4a3a] rounded-sm shadow-sm whitespace-nowrap">
                            4027-0. Ds. 1254.2024
                          </span>
                          <span className="text-[10px] font-sans font-bold text-[#722f37] uppercase tracking-tighter">Śledztwo zawieszone</span>
                        </div>
                    </div>
                 </div>

                 <div className="mt-8 text-sm text-[#6b5b45] font-sans text-center md:text-left">
            ...
            <footer className="mt-4 pt-8 border-none font-sans z-10 relative">
               ...
               <div className="mb-8">
                 ...
                 <div className="border-b border-[#c4b99a] w-full mb-6"></div>
                 <p className="text-base text-[#5a4a3a] italic text-left">
               ...
               <div className="grid gap-4 text-sm text-[#6b5b45]">

                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        <h4 className="font-bold text-[#3d2b1f] text-sm leading-tight">Wyrok <strong>Jarosława Kordysa</strong></h4>
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">Sygn. 30 T 5/2020</p>
                      </div>
                      <a
                        href={KORDYS_PDF_URL}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="shrink-0 w-40 justify-center bg-[#e8e0cc] text-[#722f37] px-3 py-1 text-xs font-bold rounded border border-[#c4b99a] hover:bg-[#faf6ec] transition-colors flex items-center gap-2 underline decoration-double decoration-[#b8a880]"
                      >
                        <FileText className="w-3 h-3" /> Pobierz PDF
                      </a>
                    </div>
                    <div className="border-t border-[#c4b99a]/50 pt-2">
                      <a
                        href="https://msp.gov.cz/web/krajsky-soud-v-ostrave/zakladni-informace/-/clanek/informace-rok-2022"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-[10px] text-[#8a7a62] hover:text-[#722f37] flex items-center gap-1 uppercase tracking-wider underline decoration-double decoration-[#c4b99a]"
                      >
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        ...
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">Sygn. 66 T 146/2021</p>
                      </div>
                      <a
                        href={BADI_PDF_URL}
                        target="_blank"
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        ...
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">
                          LV 127 | Obręb 656976 <span className="block sm:inline sm:ml-2 text-[#b8a880]">| Koszt: 100 CZK (~17 PLN)</span>
                        </p>
                      </div>
                      <a
                        href="#"
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        ...
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">
                          LV 832 | Obręb 708186 <span className="block sm:inline sm:ml-2 text-[#b8a880]">| Koszt: 100 CZK (~17 PLN)</span>
                        </p>
                      </div>
                      <a
                        href="#"
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        ...
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">
                          Sygnatura: V-5821/2023 <span className="block sm:inline sm:ml-2 text-[#b8a880]">| Koszt: 300 CZK (~52 PLN)</span>
                        </p>
                      </div>
                      <a
                        href="#"
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        ...
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">
                          Sygnatura: V-2937/2021 <span className="block sm:inline sm:ml-2 text-[#b8a880]">| Koszt: 300 CZK (~52 PLN)</span>
                        </p>
                      </div>
                      <a
                        href="#"
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        ...
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">Archiwum: tribunydek.com</p>
                      </div>
                      <a
                        href="https://web.archive.org/web/*/tribunydek.com"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="shrink-0 w-40 justify-center bg-[#faf6ec] text-[#6b5b45] px-3 py-1 text-xs font-bold rounded border border-[#c4b99a] hover:bg-[#e8e0cc] transition-colors flex items-center gap-2 underline decoration-double decoration-[#b8a880]"
                      >
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        ...
                        <p className="font-mono text-[10px] text-[#8a7a62] mt-1">Archiwum: munaysonqo.com (Peru)</p>
                      </div>
                      <a
                 ...
                 <div className="p-3 bg-[#f5f0e1] border border-[#c4b99a] border-l-[#b8a880] border-l-4 hover:border-[#b8a880] transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                      <div>
                        <h4 className="font-bold text-[#3d2b1f] text-sm leading-tight">
                          Artykuł: <strong>Szamańskie ceremonie, tajemnicza śmierć i miliarderzy od „Wiedźmina”</strong>, <span className="text-[#8a7a62] font-medium">Onet.pl</span>
                        </h4>
                        <p className="font-mono text-[10px] text-[#b8a880] mt-1 uppercase tracking-wider">Opublikowano: 3 marca 2026</p>
                      </div>
                      <div className="shrink-0 w-40 justify-center bg-[#faf6ec] text-[#b8a880] px-3 py-1 text-xs font-bold rounded border border-[#c4b99a] flex items-center gap-2 cursor-default">
                        <ExternalLink className="w-3 h-3" /> Link nieaktywny
                      </div>
                    </div>
                    <div className="border-t border-[#c4b99a]/50 pt-2 text-[10px] text-[#b8a880] font-mono italic">
               ...
               <div className="mt-8 text-center pb-12">
                  <div className="w-24 h-px bg-[#c4b99a] mx-auto mb-6"></div>

                  <div className="mb-10 bg-[#faf6ec] p-6 border border-[#c4b99a] rounded-sm text-center">
                    ...
                    <p className="text-xs text-[#6b5b45] mb-4 leading-relaxed font-sans max-w-lg mx-auto">
                    ...
                    <div className="grid gap-3 font-mono text-[10px] uppercase tracking-wider">
                      <a href="ipfs://bafybeicnxl_pelna_dokumentacja_wiedzmin_gate" className="text-[#3d2b1f] font-bold hover:bg-[#e8e0cc] underline decoration-[#b8a880] decoration-double">IPFS: Baza Dowodowa (Full Archive)</a>
                      <a href="https://arweave.net/eliksir-wiedzmina-dokumentacja" className="text-[#3d2b1f] font-bold hover:bg-[#e8e0cc] underline decoration-[#b8a880] decoration-double">Arweave: Trwała Archiwizacja</a>
                      <a href="https://github.com/detektyw-polutek/eliksir-mirror" className="text-[#3d2b1f] font-bold hover:bg-[#e8e0cc] underline decoration-[#b8a880] decoration-double">GitHub: Source Mirror</a>
                    </div>
                  </div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-mono text-sm font-bold text-[#722f37] hover:bg-[#e8e0cc] transition-colors underline decoration-double decoration-[#b8a880]"
                  >
