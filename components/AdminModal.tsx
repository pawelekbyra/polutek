...
export default function AdminModal() {
    ...
    return (
        <div className="fixed inset-0 z-[10300] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 md:w-[calc(100vh*9/16)] md:left-1/2 md:-translate-x-1/2">
            <motion.div
