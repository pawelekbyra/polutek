...
const BrandHeader = () => (
  <div className="w-full flex flex-col items-center bg-[#f8f5f0]">
    {/* thin top rule */}
    <div className="w-full h-[3px] bg-[#0f0f0f]" />

    {/* meta row */}
    <div className="w-full flex items-center justify-between px-5 pt-2 pb-1 text-[9px] font-mono uppercase tracking-[0.28em] text-[#0f0f0f]">
      <span className="opacity-50">Niezależny Serwis Śledczy</span>
      <span className="opacity-30 hidden sm:block">— Dokumentacja Jawna —</span>
      <span className="opacity-50">Nr 01 / 2026</span>
    </div>

    {/* thin separator */}
    <div className="w-full h-px bg-[#0f0f0f] opacity-20" />

    {/* MASTHEAD — stacked block letters + red slash accent */}
    <div className="w-full flex flex-col items-center py-6 px-4 relative overflow-hidden">
      {/* decorative large background letter */}
      <span
        className="absolute select-none pointer-events-none text-[22rem] font-black leading-none text-[#0f0f0f] opacity-[0.03] top-1/2 left-1/2"
        style={{ transform: 'translate(-50%, -50%)', fontFamily: '"Georgia", serif' }}
        aria-hidden
      >N</span>

      {/* top thin rule with red center diamond */}
      <div className="w-full max-w-3xl flex items-center gap-0 mb-3">
        <div className="flex-1 h-[2px] bg-[#0f0f0f]" />
        <div className="w-3 h-3 bg-[#b8001f] rotate-45 mx-3 shrink-0" />
        <div className="flex-1 h-[2px] bg-[#0f0f0f]" />
      </div>

      {/* main title — two lines, condensed */}
      <div className="text-center leading-none select-none">
        <div
          className="block font-black uppercase text-[#0f0f0f]"
          style={{
        ...
        <div className="flex items-center justify-center gap-4 mt-1">
          <div className="h-px bg-[#b8001f] flex-1 max-w-[3rem] hidden sm:block" />
          <div
            className="block font-black uppercase text-[#0f0f0f]"
            style={{
              fontFamily: '"Georgia", serif',
      ...
      <div className="mt-3 flex items-center gap-3">
        <div className="w-8 h-px bg-[#b8001f]" />
        <span className="font-mono text-[9px] uppercase tracking-[0.35em] text-[#b8001f] font-bold">
      ...
      {/* bottom rule */}
      <div className="w-full max-w-3xl flex items-center gap-0 mt-3">
        <div className="flex-1 h-[2px] bg-[#0f0f0f]" />
        <div className="w-3 h-3 bg-[#b8001f] rotate-45 mx-3 shrink-0" />
        <div className="flex-1 h-[2px] bg-[#0f0f0f]" />
      </div>
    ...
    {/* date bar */}
    <div className="w-full border-t-[3px] border-[#0f0f0f] bg-[#0f0f0f] py-1.5 px-5 flex items-center justify-between text-[9px] font-mono uppercase tracking-[0.25em] text-[#f8f5f0]">
      <span className="opacity-60 hidden sm:block">Dokumentacja Jawna</span>
      <span className="font-bold tracking-[0.3em] mx-auto sm:mx-0">Niedziela, 1 Marca 2026</span>
      <span className="opacity-60 hidden sm:block">Polska / Czechy</span>
    </div>
  </div>
);
