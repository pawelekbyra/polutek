...
const BrandHeader = () => {
  ...
  const [currentDate, setCurrentDate] = useState("NIEDZIELA, 1 MARCA 2026");
  ...
  return (
    <div className="max-w-4xl mx-auto mb-12 border-t-4 border-stone-900 pt-8">
      <div className="text-center pb-8">
        <h1 className="text-5xl sm:text-7xl md:text-9xl font-black tracking-tighter text-stone-900 uppercase font-serif leading-none whitespace-nowrap">
          NASZA GAZETKA
        </h1>
      </div>
      ...
      <div className="border-y-2 border-stone-900 py-2 flex items-center justify-between px-4 text-[10px] md:text-sm font-bold uppercase tracking-[0.15em] text-stone-800">
        <div className="flex items-center gap-3">
          ...
          <span className="hidden sm:inline">Niezależny Serwis Śledczy</span>
          <span className="sm:hidden">Serwis Śledczy</span>
        </div>

        <div className="flex items-center gap-2">
          <span className="text-stone-400">•</span>
          <span className="text-center">{mounted ? currentDate : "NIEDZIELA, 1 MARCA 2026"}</span>
          <span className="text-stone-400">•</span>
        </div>

        <div className="flex items-center gap-3">
          <span className="hidden sm:inline text-right">Wydanie Specjalne</span>
...
export default function ElixirClientPage() {
  return (
