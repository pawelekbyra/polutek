...
<p className="mt-2">
  <span className="bg-red-600 px-1 font-black text-white shadow-sm box-decoration-clone">
    Wspólnikiem szamana był twórca Wiedźmina – jeden z najbogatszych Polaków.
              ...
              <p className="mt-4">
                Na mocy wyroku z dnia 2 listopada 2021<span className="cursor-pointer hover:bg-[#e8d154]/50 transition-colors rounded px-1" title="Kliknij, aby zobaczyć wyrok (atrapa)">🔍</span>  roku Bartosz Badowski został uznany winnym popełnienia zbrodni niedozwolonej produkcji i innego obchodzenia się ze środkami odurzającymi.
              </p>
