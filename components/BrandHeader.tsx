  ...
  return (
    <header className="w-full mb-8">
      ...
      <div className="py-10 border-b border-gray-200 bg-white text-center">
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter uppercase italic text-black">
          Nasza Gazetka
        </h1>
      ...
      <div className="bg-black text-white py-2 px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-[10px] md:text-xs font-bold uppercase tracking-widest min-h-[1.5rem]">
