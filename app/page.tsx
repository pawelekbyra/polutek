...
<div className="p-6 font-mono text-sm md:text-base leading-relaxed text-black antialiased">
{children}
</div>
</div>
);
  ...
  <main className="min-h-screen bg-transparent text-black selection:bg-[#e8d154]/50 font-body flex flex-col items-center relative">
    ...
    >
      ...
      <article className="max-w-3xl mx-auto px-6 pt-4 pb-0 flex-grow w-full z-10 relative">
        <div className="article-prose text-black text-lg font-serif">
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Świadek B.</h2>
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Na podsłuchu</h2>
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Cena wolności</h2>
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Cisza po burzy</h2>
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Kiciński</h2>
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Błąd z Badim</h2>
          ...
          <div className="my-12 flex flex-col items-center relative z-10 font-sans">
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Anonimowy filantrop</h2>
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Nýdek</h2>
          ...
          <p className="mt-4 font-bold text-center my-8 uppercase font-sans">
          ...
          <p className="mt-4">
            <span className="bg-[#e8d154]/80 px-1 font-black text-black shadow-sm">Oznacza to, że nie jeden lecz obaj legendarni założyciele CD Projekt, na czeskim pograniczu posiadali nieruchomości, v których odpłatnie oferowano te same nielegalne substancje.</span>
          </p>
          ...
          <h2 className="section-heading text-4xl font-black tracking-tighter text-black uppercase border-b-4 border-black mb-6 mt-16 font-sans">Wiktor B.</h2>
          ...
          <div className="mt-12 mb-4 flex justify-end relative z-10 font-sans">
          ...
          <div className="mt-16 mb-0 border-y-4 border-black py-8 bg-[#e8d154]/10 relative z-10 font-sans">
              ...
              <div className="grid gap-4 px-4">
                <div className="border-2 border-black bg-white p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                   <div>
                     ...
                     <span className="block text-xs text-black/60 mt-1 font-mono">Prokuratura Rejonowa v Częstochowie</span>
                   </div>
        ...
        <footer className="mt-8 pt-0 font-mono relative z-10 mb-0 font-sans">
           ...
           <div className="grid gap-6 text-sm text-black">
             ...
             <div className="p-4 bg-white/40 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-[#e8d154]/10 transition-colors">
                ...
                <div className="border-t-2 border-black/20 pt-3">
                  <a href="[https://nahlizenidokn.cuzk.cz](https://nahlizenidokn.cuzk.cz)" target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-black/70 hover:text-black flex items-center gap-2 uppercase tracking-widest underline decoration-2 underline-offset-4">
           ...
           <div className="mt-4 text-center pb-8 font-sans">
