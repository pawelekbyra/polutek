...
const BrandHeader = () => {
  return (
    <div className="w-full pb-2 mb-2 flex flex-col items-center">
      ...
      <div className="w-[98%] mx-auto border-y-[2px] border-stone-900 py-1">
        {/* ZMIANA: Dodano max-w-3xl, mx-auto i px-6, by zrównać z tekstem artykułu */}
        <div className="max-w-3xl mx-auto flex items-center justify-between px-6 text-[10px] md:text-sm font-bold uppercase tracking-[0.1em] text-stone-800">
...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* ZMIANA: Usunięto padding-top z głównego kontenera (było pt-4) */}
      <main className="min-h-screen bg-[#e4dbbe] text-[#1c1917] selection:bg-yellow-900/20 font-serif flex flex-col items-center overflow-x-hidden">
        ...
        {/* Constrained content section with vertical borders only */}
        {/* ZMIANA: Usunięto margin-top (było mt-1) */}
        <div className="w-[96%] max-w-5xl border-x-[2px] border-stone-900 flex-grow flex flex-col relative z-10 pb-12">
          
          <div className="w-full text-center flex flex-col justify-center items-center pb-6 px-6 pt-0">
            <img
              src="/zdjeciehej.png"
              alt="Wiedźmini z eliksirem"
              className="h-32 md:h-[180px] object-contain grayscale contrast-200 mix-blend-multiply mb-1 mt-4"
            />
