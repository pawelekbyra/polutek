...
const CaseFile = ({ title, children, type = 'evidence' }: { title: string, children: React.ReactNode, type?: 'evidence' | 'transcript' | 'email' }) => (
  <div className="my-10 border border-stone-400 bg-white shadow-sm rounded-sm overflow-hidden break-inside-avoid">
    <div className="bg-stone-100 border-b border-stone-200 px-4 py-2 flex items-center gap-2 text-xs font-mono text-stone-600 uppercase tracking-wider font-bold">
...
const EvidenceVideo = ({ src, title, caption }: { src: string, title: string, caption: string }) => (
  <figure className="my-14">
    <div className="aspect-w-16 aspect-h-9 bg-black rounded-sm shadow-xl overflow-hidden relative group border border-stone-300">
      <iframe
        src={src}
        title={title}
    ...
    <figcaption className="mt-3 text-sm text-stone-500 font-sans border-l-2 border-stone-400 pl-3 font-medium">
...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#FDFBF7] text-[#1a1a1a] selection:bg-yellow-200/50 font-serif">
      ...
      {/* HEADER REPORTAŻU */}
      <header className="pt-24 pb-16 px-4 border-b border-stone-300">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-block mb-6 px-4 py-1 border border-stone-900 text-[10px] font-sans font-bold tracking-[0.2em] uppercase text-stone-900">
          ...
          <p className="text-xl md:text-2xl text-stone-700 leading-relaxed italic border-y border-stone-200 py-10 my-10">
      ...
      <article className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-stone prose-lg md:prose-xl max-w-none prose-headings:font-sans prose-headings:font-bold prose-headings:tracking-tight prose-a:text-blue-800 hover:prose-a:text-blue-900 prose-blockquote:not-italic">
