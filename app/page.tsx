  ...
  return (
    <div className="w-full flex flex-col items-center pt-8 pb-4">
      <div className="flex items-center justify-center w-full pb-2">
        <h1 className="text-5xl md:text-[6.5rem] font-black tracking-tighter text-ink uppercase font-serif leading-none whitespace-nowrap">
          NASZA GAZETKA
        </h1>
      </div>
      <div className="w-full border-y-2 border-ink py-1.5 flex items-center justify-between px-4 text-[10px] md:text-sm font-bold uppercase tracking-[0.1em] text-ink-medium">
        ...
        <div className="source-card">
          <div className="flex flex-col h-full">
            ...
            <div className="mt-auto">
              <a href="/wezwanie_kicinski.png" target="_blank" className="w-full inline-flex justify-center bg-parchment text-ink px-3 py-2 text-xs font-bold rounded border border-sepia-light hover:bg-parchment-warm transition-colors underline decoration-double decoration-sepia">
                POKAŻ DOWÓD
              </a>
            </div>
          </div>
    ...
    <>
      ...
      <main className="min-h-screen bg-white text-ink selection:bg-parchment-warm/50 font-body flex flex-col items-center">
        <div className="w-full max-w-4xl px-4 flex flex-col items-center pb-20">
          ...
          <div className="w-full text-center flex flex-col justify-center items-center pb-6 pt-8">
            <img
              src="/zdjeciehej.png"
              alt="Wiedźmini z eliksirem"
              className="h-32 md:h-[180px] object-contain grayscale contrast-200 mix-blend-multiply mb-6"
            />
            ...
            <h2 className="text-ink w-full mb-1">
              ...
              <span className="block text-sm md:text-2xl text-ink-medium italic font-medium uppercase tracking-widest mt-6 whitespace-nowrap">
            ...
            <div className="max-w-3xl mx-auto px-4 mt-8">
              ...
              <p className="text-xl md:text-2xl text-ink-medium leading-relaxed italic">
          ...
          <article className="max-w-3xl mx-auto px-6 pt-12 pb-0 flex-grow w-full z-10 relative">
            <div className="article-prose">
              ...
              <p>
                Odpowiedź na to question znajduje się w aktach sprawy i nie pozostawia złudzeń co do intencji rozmówców. W uzasadnieniu wyroku Kordysa czytamy:
              </p>
              ...
              <p>
                Fakt, że Kiciński w momencie przesłuchania zarządzał legalnym biznesem ayahuaskowym in Ameryce Południowej, stawia pod znakiem zapytania jego deklarowaną nieświadomość co do profilu działalności w Janowie.
              </p>
              ...
              <div className="grid gap-4 text-sm text-ink-medium">
                ...
                <div className="source-card">
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                    ...
                    <a href="https://nahlizenidokn.cuzk.cz" target="_blank" className="shrink-0 w-40 justify-center bg-parchment text-ink px-3 py-1 text-xs font-bold rounded border border-sepia-light hover:bg-parchment-warm transition-colors flex items-center gap-2 underline decoration-double decoration-sepia">
