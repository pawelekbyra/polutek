        ...
        >
          ...
          <div className="w-full text-center flex flex-col items-center pt-6 pb-4 px-6 box-border relative z-10">
            ...
            <div className="max-w-3xl mx-auto mt-6">
              <p className="text-sm md:text-lg text-[#1a1a1a] leading-relaxed italic font-serif font-bold px-4">
          ...
          <div 
  className="prose prose-stone prose-lg max-w-none article-prose font-serif text-lg leading-relaxed p-6" 
  style={{ color: '#1a1a1a', backgroundColor: '#FDFBF7', opacity: 1, WebkitFontSmoothing: 'none' }}
>
              ...
              <CaseFile title="Własność nieruchomości">
                (...) budynek rodzinny v miejscowości Janów (...), który jest częściowo użytkowany do stałego zamieszkania, a częściowo jako komercyjny obiekt noclegowy.
                <br/><br/>
                Świadek [Bartosz B.] potwierdził, że v Janowie jest właścicielem jednej dziesiątej nieruchomości.
              </CaseFile>
              ...
              <CaseFile title="Ustalenia Sądu">
                ...v odniesieniu do nieruchomości będących współwłasnością <strong className="font-black">Bartosza B.</strong> i <strong className="font-black">Michała D. K.</strong><span className="cursor-pointer hover:bg-[#e8d154]/50 transition-colors rounded px-1" title="Kliknij, aby zobaczyć zdjęcie (atrapa)">📸</span>
              </CaseFile>
            ...
            <p className="mt-4">
  Drugie imię – Dawid – idealnie wypełnia lukę v zanonimizowanym skrócie Michal D. K.
</p>
<p className="mt-2">
  <span className="bg-red-600 px-1 font-black text-white shadow-sm box-decoration-clone">
    Wspólnikiem szamana był twórca Wiedźmina – jeden z najbogatszych Polaków.
              ...
              <p className="mt-4">
                Przełom v sprawie organizatorów ayahuaskowych ceremonii v 2020 roku nastąpił dzięki policyjnej technice operacyjnej. Telefon Kordysa był na stałym podsłuchu, a funkcjonariusze słuchali na żywo, gdy v dniu 24.08.2020 r. doszło do nerwowej wymiany zdań pomiędzy Badowskim i Kordysym.
              </p>
              ...
              <CaseFile title="Rekonstrukcja rozmowy (Uzasadnienie Sądu)" type="transcript">
                oskarżony [Jarosława Kordysa] omawia z B., że dotarła do niego informacja, że v obiekcie v Janowie <span className="underline decoration-red-700 decoration-4 underline-offset-4 font-bold">zmarła jakaś kobieta</span>.
              </CaseFile>
              ...
              <CaseFile title="Kontynuacja rozmowy" type="transcript">
                Następnie v rozmowie omawiają zamówienia «herbaty» z dżungli i to, czy im tego «nie zepsują», ekscytując się nagraniem od dostawcy, który «siedzi v dżungli i gotuje».
              </CaseFile>
              ...
              <p className="mt-4">
                Kiedy 26 sierpnia 2020 roku czeska policja weszła do posiadłości v Janowie, należącej do Bartosza Badowskiego i miliardera Michała Kicińskiego, Jarosław Kordys v Hermanovicach vciąż czuł się bezpiecznie. Nie wiedział jeszcze, że zegar zaczął odliczać czas do jego własnej katastrofy. Zaledwie 7 tygodni po cichym nalocie na Badowskiego policja zapukała do Kordysów.
              </p>

              <p className="mt-4">
                15 października 2020 roku sielankę v ich ośrodku przerwał huk granatów ogłuszających. Czeska jednostka antyterrorystyczna nie bawiła się v półśrodki: zamaskowani funkcjonariusze z długą bronią wdarli się do budynku, rzucając na ziemię przyszłych bohaterów głośnego skandalu.
              </p>
              ...
              <p className="mt-4">
                Będąc tak blisko Badowskiego, doskonale znali mroczną tajemnicę śmierci Ilony. Ich decyzja o zamieszkaniu z człowiekiem, który v obliczu tragedii martwił się o ciągłość dostaw, dowodzi, że v pełni akceptowali reguły zmowy milczenia.
              </p>
              ...
              <CaseFile title="Wiadomość prywatna od M. Kicińskiego" type="email">
                (...) Tak mogę zapłacić za swój błąd z Badim. Podaj mi Fundacje lub Stowarzyszenie (najlepiej powiązaną z hospicjum lub domami dziecka, bo tu widzę morze potrzeb i dużo cierpienia) i wpłacę tam dobrowolnie kwotę darowizny, v ramach Przeprosin wszechświatowi, za moją młodzieńczą naiwność i brak przenikliwości. Fundacja / Stowarzyszenie musi być uznana i z tradycjami, a nie jakaś organizacja krzak. Wyślę Ci potwierdzenie przelewu.
              </CaseFile>

              <p className="mt-4">
                Do przesłuchania doszło tydzień przed terminem wskazanym na wezwaniu – 11 października 2023 roku o godzinie 15:00 v Komendzie Rejonowej Policji Warszawa II. W protokole Kiciński przyjmuje linię opartą na braku świadomości co do charakteru działalności prowadzonej v jego posiadłości.
              </p>

              <CaseFile title="Zeznanie do protokołu">
                Nie mam żadnej wiedzy co się działo na mojej farmie, v której jestem 90% udziałowcem (...) wynajmowałem tę nieruchomość.
              </CaseFile>
              ...
              <CaseFile title="Odpowiedź na pytanie o udział">
                nie brałem udziału v takich ceremoniach v latach 2016-2023, a o wcześniejszym okresie <span className="underline decoration-black decoration-4 underline-offset-4 font-black">odmawiam odpowiedzi</span>
              </CaseFile>
              ...
              <p className="mt-4">
                W przeciwieństwie do Europy, peruwiańskie prawo zezwala na komercyjne prowadzenie ceremonii z ayahuascą. Ośrodek Kicińskiego oferuje tam v pełni jawną i profesjonalną sprzedaż usług o profilu bliźniaczym do tych, które v Czechach są zakazane, co vciąż jest eksponowane na stronie internetowej.
              </p>

              <p className="mt-4">
                Fakt, że Kiciński v momencie przesłuchania zarządzał legalnym biznesem ayahuaskowym v Ameryce Południowej, stawia pod znakiem zapytania jego deklarowaną nieświadomość co do profilu działalności v Janowie.
              </p>
              ...
              <p className="mt-4">
                W listopadzie 2025 roku na kanale YouTube <strong className="font-black">Osada Natury Zew</strong> pojawia się nagrany rok wcześniej film, v którym obecny gospodarz, <strong className="font-black">Krzysztof Stefanek</strong>, snuje opowieść o powstaniu Osady. W sielskiej scenerii, z uśmiechem na ustach, buduje narrację o cudownym zbiegu okoliczności i tajemniczym dobroczyńcy.
              </p>
              ...
              <p className="mt-4">
                <span className="bg-red-600 px-1 font-black text-white shadow-sm box-decoration-clone">Oznacza to, że nie jeden lecz obaj legendarni założyciele CD Projekt, na czeskim pograniczu posiadali nieruchomości, v których odpłatnie oferowano te same nielegalne substancje.</span>
              </p>

              <p className="mt-4">
                Jeszcze bardziej zastanawiające jest to, co stało się z tą nieruchomością v momencie zagrożenia. Gdy 15.10.2020 roku aresztowano Kordysa, nad środowiskiem zawisło vidmo policyjnych nalotów. Dokumenty urzędowe odsłaniają niepokojącą zbieżność dat:
              </p>
