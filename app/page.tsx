...
export default function Page() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#e4dbbe] text-[#1c1917] selection:bg-yellow-900/20 font-serif flex flex-col items-center pt-4 overflow-x-hidden">
        ...
        <div className="w-[96%] max-w-5xl border-x-[2px] border-stone-900 flex-grow flex flex-col relative z-10 pb-12 mt-1">
