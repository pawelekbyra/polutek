...
const EvidenceGrid = () => {
  return (
    <div className="my-16" id="galeria">
      <h3 className="text-2xl font-bold text-stone-900 uppercase tracking-widest mb-8 border-b-2 border-amber-900/30 pb-2 flex items-center gap-3">
        ⚖️ Galeria Dowodów
      </h3>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Wezwanie Kiciński */}
        <div className="group relative overflow-hidden bg-[#f4ebd8] border border-amber-900/20 shadow-md flex flex-col text-left">
          <div className="aspect-[3/4] overflow-hidden bg-[#d8ccaf]">
            <img
              src="/wezwanie_kicinski.png"
              alt="Wezwanie Kiciński"
              className="w-full h-full object-cover grayscale-[40%] sepia-[30%] group-hover:grayscale-0 transition-all duration-500"
            />
          </div>
          <div className="p-4 bg-[#fbf6ea]/95 border-t border-amber-900/10">
            <h4 className="font-bold text-stone-900 text-sm mb-1 uppercase tracking-tight">Wezwanie dla M. Kicińskiego</h4>
            <p className="text-[10px] text-amber-900/70 font-mono">Sygn. WD-I-3186/23</p>
            <a href="/wezwanie_kicinski.png" target="_blank" className="text-[10px] font-bold text-red-800 underline decoration-red-800/40 mt-2 inline-block hover:text-red-900">POKAŻ DOWÓD</a>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden bg-[#f4ebd8] border border-amber-900/20 shadow-md flex flex-col text-left">
          ...
          <div className="p-4 bg-[#fbf6ea]/95 border-t border-amber-900/10">
            ...
            <p className="text-[10px] text-amber-900/70 font-mono">Sygn. 30 T 5/2021</p>
            <details className="mt-2">
              <summary className="text-[10px] font-bold text-red-800 cursor-pointer hover:text-red-900">POKAŻ STRONY (25)</summary>
              <div className="flex flex-col gap-2 mt-2">
                {GALLERY_WYROK_KORDYS.map((img, i) => (
                  <a key={i} href={img} target="_blank" className="text-[9px] text-amber-900 underline decoration-amber-900/30 hover:bg-amber-900/10 px-1 -mx-1 rounded">Strona {i+1}</a>
                ))}
              </div>
            </details>
          </div>
        ...
        <div className="group relative overflow-hidden bg-[#f4ebd8] border border-amber-900/20 shadow-md flex flex-col text-left">
          ...
          <div className="p-4 bg-[#fbf6ea]/95 border-t border-amber-900/10">
            ...
            <p className="text-[10px] text-amber-900/70 font-mono">Sygn. 66 T 146/2021</p>
            <details className="mt-2">
              <summary className="text-[10px] font-bold text-red-800 cursor-pointer hover:text-red-900">POKAŻ STRONY (3)</summary>
              <div className="flex flex-col gap-2 mt-2">
        ...
        <div className="group relative overflow-hidden bg-[#f4ebd8] border border-amber-900/20 shadow-md flex flex-col text-left">
          ...
          <div className="p-4 bg-[#fbf6ea]/95 border-t border-amber-900/10">
            ...
            <p className="text-[10px] text-amber-900/70 font-mono">KW LV 127</p>
            <details className="mt-2">
              <summary className="text-[10px] font-bold text-red-800 cursor-pointer hover:text-red-900">POKAŻ GALERIĘ</summary>
              <div className="flex flex-col gap-2 mt-2">
                {GALLERY_JANOV.map((img, i) => (
                  <a key={i} href={img} target="_blank" className="text-[9px] text-amber-900 underline decoration-amber-900/30 hover:bg-amber-900/10 px-1 -mx-1 rounded">Zdjęcie {i+1}</a>
                ))}
              </div>
            </details>
          </div>
        ...
        {/* Posiadłość Nýdek */}
        <div className="group relative overflow-hidden bg-[#f4ebd8] border border-amber-900/20 shadow-md flex flex-col text-left">
          <div className="aspect-[3/4] overflow-hidden bg-[#d8ccaf] flex items-center justify-center">
            <span className="text-4xl opacity-50">🏠</span>
          </div>
          <div className="p-4 bg-[#fbf6ea]/95 border-t border-amber-900/10 flex-grow">
            <h4 className="font-bold text-stone-900 text-sm mb-1 uppercase tracking-tight">Posiadłość w Nýdku</h4>
            <p className="text-[10px] text-amber-900/70 font-mono">KW LV 832 (M. Iwiński)</p>
            <details className="mt-2">
              <summary className="text-[10px] font-bold text-red-800 cursor-pointer hover:text-red-900">POKAŻ GALERIĘ</summary>
              <div className="flex flex-col gap-2 mt-2">
  ...
  return (
    <div className="w-full pb-2 mb-2 flex flex-col items-center">
      <div className="flex items-center justify-center w-[98%] mx-auto pb-2">
        <h1 className="text-5xl md:text-[6.5rem] font-black tracking-tighter text-stone-900 uppercase font-serif leading-none whitespace-nowrap drop-shadow-sm">
          NASZA GAZETKA
        </h1>
      </div>

      <div className="w-[98%] mx-auto border-y-[2px] border-stone-900/80 py-1 flex items-center justify-between px-2 text-[10px] md:text-sm font-bold uppercase tracking-[0.1em] text-amber-900">
        <div className="flex items-center gap-2">
          <span>📰</span>
          <span className="hidden sm:inline">Niezależne Media</span>
        </div>

        <div className="text-center font-serif text-stone-800">
        ...
        <div className="flex items-center gap-2">
          ...
          <span>📄</span>
          <span className="hidden md:inline border-l border-amber-900/30 pl-2 ml-1">Nr 01</span>
        </div>
      </div>
    </div>
  );
...
const CaseFile = ({ title, children, icon = '📄' }: { title: string, children: React.ReactNode, icon?: string }) => (
  <div className="my-8 border border-amber-900/20 bg-[#f4ebd8]/70 shadow-sm rounded-sm overflow-hidden break-inside-avoid text-left">
    <div className="bg-[#dcd1b3]/60 border-b border-amber-900/10 px-4 py-2 flex items-center gap-2 text-xs font-mono text-amber-900 uppercase tracking-wider font-bold">
      <span>{icon}</span>
      <span>{title}</span>
    </div>
...
const PullQuote = ({ quote, author, source }: { quote: string, author: string, source: string }) => (
  <div className="my-10 pl-6 border-l-[3px] border-red-800/60 text-left">
    <p className="font-serif text-xl md:text-2xl italic text-stone-900 leading-relaxed mb-3">
      „{quote}”
    </p>
    <div className="font-sans text-[10px] uppercase tracking-widest text-amber-900/70">
...
const LocationStampUI = ({ name, plot, lv }: { name: string, plot: string, lv: string }) => (
  <div className="relative border border-amber-900/30 bg-[#fbf6ea] p-1 pr-6 rounded-sm flex items-center gap-4 shadow-[2px_2px_0px_0px_rgba(120,53,15,0.15)] text-left group">
     <div className="absolute top-1 right-1 text-amber-900/30">
       🔍
     </div>
     <div className="bg-[#e4dbbe]/50 h-full p-3 flex items-center justify-center border-r border-amber-900/20 border-dashed transition-colors">
        <span className="text-xl">🏠</span>
     </div>
     <div className="py-2">
        <div className="text-[9px] uppercase tracking-[0.2em] text-red-800/80 font-bold mb-1 flex items-center gap-2">
          {name}
        </div>
        <div className="font-mono text-base font-bold text-stone-900">LV {lv}</div>
        <div className="text-[10px] text-amber-900/70 font-mono mt-1">
          Działka: {plot}
        </div>
     </div>
  </div>
...
const TransactionStampUI = ({ label, value, subDetails }: { label: string, value: string, subDetails?: string }) => (
  <div className="relative border border-amber-900/30 bg-[#fbf6ea] p-1 pr-6 rounded-sm flex items-center gap-4 shadow-[2px_2px_0px_0px_rgba(120,53,15,0.15)] group text-left">
     <div className="absolute top-1 right-1 text-amber-900/30">
       🔍
     </div>
     <div className="bg-[#e4dbbe]/50 h-full p-3 flex items-center justify-center border-r border-amber-900/20 border-dashed">
        <span className="text-xl">📜</span>
     </div>
     <div className="py-2">
        <div className="text-[9px] uppercase tracking-[0.2em] text-red-800/80 font-bold mb-1">{label}</div>
        <div className="font-mono text-base font-bold text-stone-900">{value}</div>
        {subDetails && <div className="text-[10px] text-amber-900/70 font-mono mt-1">{subDetails}</div>}
     </div>
  </div>
);
...
const ArticleVideoPlayer: React.FC<{ src: string; poster: string }> = ({ src, poster }) => {
  return (
    <div className="my-12 w-full bg-[#1c1917] rounded-sm shadow-xl overflow-hidden border border-amber-900/20">
      <video controls poster={poster} className="w-full h-auto block opacity-95">
        <source src={src} type="application/x-mpegURL" />
        Twoja przeglądarka nie obsługuje odtwarzacza wideo. <a href={src} className="text-amber-500 underline">Pobierz plik</a>.
      </video>
    </div>
  );
};
...
export default function Page() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#e4dbbe] text-[#1c1917] selection:bg-amber-900/20 selection:text-amber-950 font-serif flex flex-col items-center">
        <div className="w-full max-w-5xl bg-[#e4dbbe] min-h-screen shadow-2xl border-x-[2px] border-stone-900/80 flex flex-col relative overflow-hidden">
          ...
          <div className="w-full mx-auto flex-grow flex flex-col z-10 relative">
            ...
            <div className="w-full text-center flex flex-col justify-center items-center pb-6 px-6 pt-0">
              <img
                src="/zdjeciehej.png"
                alt="Wiedźmini z eliksirem"
                className="h-32 md:h-[180px] object-contain grayscale-[30%] sepia-[20%] contrast-150 mix-blend-multiply mb-1"
              />

              <h2 className="text-stone-900 w-full mb-1 drop-shadow-sm">
                <span className="block text-4xl md:text-[5.5rem] font-bold leading-none tracking-tight uppercase">
                  Eliksir Wiedźmina
                </span>
                <span className="block text-sm md:text-2xl text-red-900/90 italic font-medium uppercase tracking-widest mt-1 whitespace-nowrap">
            ...
            <article className="max-w-3xl mx-auto px-6 pt-2 pb-0 flex-grow w-full z-10 relative">
              <div className="prose prose-stone prose-lg max-w-none prose-headings:font-sans prose-headings:font-bold prose-blockquote:not-italic
                prose-a:text-red-900 prose-a:font-bold prose-a:no-underline prose-a:underline prose-a:decoration-double prose-a:decoration-red-800/40 hover:prose-a:bg-red-800/10 transition-colors">

                <p className="first-letter:text-7xl first-letter:font-bold first-letter:mr-3 first-letter:float-left first-letter:text-red-900 leading-relaxed mt-0">
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Świadek B.</h2>

                <p>
                  W obszernym i publicznie dostępnym uzasadnieniu <a href="#galeria">wyroku</a> Jarosława Kordysa pojawia się postać świadka Bartosza B.
                </p>
                ...
                <p>
                  W Czechach księgi wieczyste są jawne i dostępne online. Wystarczy wejść na stronę Katastru Nieruchomości, wyszukać <a href="#galeria">działkę w Janowie</a> i za niewielką opłatą pobrać jej pełną historię.
                </p>
                ...
                Pobrany dokument nie pozostawia wątpliwości: w latach 2012–2023 współwłaścicielami nieruchomości byli:
                   ...
                   Bartosz Badowski (10%)
                   <br/>
                   <span className="bg-red-900/90 px-1 font-bold text-[#e4dbbe] box-decoration-clone rounded-sm">Michał Dawid Kiciński (90%)</span>
                </p>

                <p>
                  Drugie imię – Dawid – idealnie wypełnia lukę w zanonimizowanym skrócie &quot;Michal D. K.&quot;. <span className="bg-amber-900/90 px-1 font-bold text-[#e4dbbe] shadow-sm box-decoration-clone rounded-sm">Wspólnikiem szamana był twórca &quot;Wiedźmina&quot; – jeden z najbogatszych Polaków.</span>
                </p>

                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Na podsłuchu</h2>
                ...
                <div className="my-12 pl-6 border-l-4 border-amber-800 font-serif italic text-xl text-stone-800 bg-gradient-to-r from-amber-900/5 to-transparent py-2">
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Cena wolności</h2>
                ...
                <div className="my-12 w-full rounded-sm overflow-hidden shadow-md">
                 ...
                 <div className="mt-1 text-sm text-stone-700 font-sans border-l-2 border-amber-900/30 pl-3 mb-12 bg-amber-900/5 py-2">
                     <span className="font-bold text-red-900 uppercase text-xs mr-2">Materiał Operacyjny:</span>
                ...
                <div className="my-12 flex gap-4 p-5 bg-[#f4ebd8]/50 border-l-4 border-amber-800 rounded-r-lg shadow-sm">
                  <span className="text-3xl mt-1">⚖️</span>
                  <div>
                    <strong className="block font-serif text-amber-900 text-lg font-bold mb-1">Dohoda o vině a trestu</strong>
                ...
                <p>
                   Na mocy <a href="#galeria">wyroku</a> z dnia 2 listopada 2021 roku Bartosz Badowski został uznany winnym popełnienia &quot;zbrodni niedozwolonej produkcji i innego obchodzenia się ze środkami odurzającymi&quot;.
                </p>
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Cisza po burzy</h2>
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Kiciński</h2>
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">&quot;Błąd z Badim&quot;</h2>
                ...
                <div className="my-12 flex flex-col items-center">
                  <a href="/wezwanie_kicinski.png" target="_blank">
                    <img
                      ...
                      className="w-48 rounded shadow-md border border-amber-900/30 cursor-pointer hover:opacity-90 transition-opacity mix-blend-multiply grayscale-[30%] sepia-[20%]"
                    />
                  </a>
                  <p className="text-xs text-amber-900/80 mt-2 font-mono uppercase tracking-wider w-48 text-center">
                ...
                <CaseFile title="Odpowiedź na pytanie o udział">
                  &quot;nie brałem udziału w takich ceremoniach w latach 2016-2023, a o wcześniejszym okresie <span className="underline decoration-red-800 decoration-4 underline-offset-4 font-bold">odmawiam odpowiedzi</span>&quot;
                </CaseFile>
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Anonimowy filantrop</h2>
                ...
                <CaseFile title="Wypowiedź K. Stefanka">
                  &quot;Ostatecznie <span className="bg-amber-900/90 px-1 font-bold text-[#e4dbbe] box-decoration-clone rounded-sm">23 października 2023 roku</span> ten człowiek do nas zadzwonił powiedział, że wspólnie z żoną zdecydowali, że oni by chcieli to miejsce przekazać w darowiźnie&quot;
                </CaseFile>
                ...
                <div className="my-12 w-full rounded-sm overflow-hidden shadow-md">
                 ...
                 <div className="mt-1 text-sm text-stone-700 font-sans border-l-2 border-amber-900/30 pl-3 mb-12 bg-amber-900/5 py-2">
                    <span className="font-bold text-red-900 uppercase text-xs mr-2">Materiał Wideo:</span>
                ...
                <ul className="list-none space-y-12 my-12 font-mono text-sm border-l-2 border-amber-900/20 pl-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div className="bg-red-900/5 border border-red-900/20 p-4 rounded-sm shadow-sm w-full relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-1 h-full bg-red-800"></div>
                      <span className="font-bold text-red-900">23 października 2023 r.</span> – Zaledwie 12 dni po kłopotliwym przesłuchaniu, gdy formalności własnościowe z Badim są już dopięte, następuje telefon do Stefanka z propozycją oddania majątku wartego miliony za darmo.
                    </div>
                  </li>
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Nýdek</h2>
                ...
                <p>
                  <span className="bg-amber-900/90 px-1 font-bold text-[#e4dbbe] shadow-sm rounded-sm">Oznacza to, że nie jeden lecz obaj legendarni założyciele CD Projekt, na czeskim pograniczu posiadali nieruchomości, w których odpłatnie oferowano te same nielegalne substancje.</span>
                </p>
                ...
                <h2 className="text-3xl mt-16 mb-8 tracking-tight text-stone-900 border-b border-amber-900/20 pb-2">Wiktor B.</h2>
                ...
                <div className="mt-8 mb-4 flex justify-end">
                   <div className="text-right">
                      ...
                      <span className="block text-xs text-amber-900/70 font-sans mt-1 italic">detektyw.polutek@protonmail.com</span>
                   </div>
                </div>

                <div className="my-12 border-y-[3px] border-amber-900/30 py-8">
                   <h3 className="font-sans font-bold text-lg uppercase tracking-widest text-amber-950 mb-8 flex items-center gap-2">
                      <span>🛡️</span>
                      Status Prawny (2025/2026)
                   </h3>

                   <div className="grid gap-px bg-amber-900/10 border border-amber-900/20">
                      <div className="bg-[#fbf6ea] p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                         <div>
                            <span className="block font-serif text-stone-900 font-bold">Śledztwo w sprawie organizacji ceremonii</span>
                            <span className="block text-xs text-amber-900/70 mt-1">Prokuratura Rejonowa w Częstochowie</span>
                         </div>
                         <span className="font-mono text-xs font-bold bg-[#e4dbbe]/50 px-3 py-1.5 border border-amber-900/20 text-amber-900 rounded-sm shadow-sm whitespace-nowrap">
                            3013-1.Ds.15.2024
                         </span>
                      </div>
                      ...
                      <div className="bg-[#fbf6ea] p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                         ...
                         <span className="font-mono text-xs font-bold bg-[#dcd1b3]/50 px-3 py-1.5 border border-amber-900/30 text-amber-950 rounded-sm shadow-sm whitespace-nowrap">
                            3013-1.Ds.4.2026
                         </span>
                      </div>
                      ...
                      <div className="bg-[#fbf6ea] p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                         <div>
                            ...
                            <span className="block text-xs text-amber-900/70 mt-1">Prokuratura Rejonowa w Pułtusku</span>
                         </div>
              ...
              <footer className="mt-4 pt-8 border-none font-sans relative z-10">
                 ...
                 <div className="mb-8">
                   <h3 className="text-xl font-bold text-amber-950 uppercase tracking-widest flex items-center gap-2 mb-4">
                     <span>🔍</span> Dokumenty Źródłowe
                   </h3>
                   <div className="border-b-[3px] border-amber-900/30 w-full mb-6"></div>
                 ...
                 <div className="grid gap-4 text-sm text-stone-700">
                   ...
                   <div className="p-3 bg-[#f4ebd8]/50 border border-amber-900/20 hover:border-amber-900/50 transition-colors shadow-sm">
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                        <div>
                          <h4 className="font-bold text-stone-900 text-sm leading-tight">Wyrok <strong>Jarosława Kordysa</strong></h4>
                          <p className="font-mono text-[10px] text-amber-900/70 mt-1">Sygn. 30 T 5/2020</p>
                        </div>
                        <a
                          href={KORDYS_PDF_URL}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="shrink-0 w-40 justify-center bg-[#dfd5b6] text-amber-950 px-3 py-1 text-xs font-bold rounded border border-amber-900/20 hover:bg-[#d5cba9] transition-colors flex items-center gap-2 underline decoration-double decoration-amber-900/40"
                        >
                      ...
                      <div className="border-t border-amber-900/10 pt-2">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[10px] text-red-800/80 hover:text-red-900 flex items-center gap-1 uppercase tracking-wider underline decoration-double decoration-red-800/40"
                        >
                          <span>🌐</span>
                   ...
                   <div className="p-3 bg-[#f4ebd8]/50 border border-amber-900/20 hover:border-amber-900/50 transition-colors shadow-sm">
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                        <div>
                          ...
                          <p className="font-mono text-[10px] text-amber-900/70 mt-1">Sygn. 66 T 146/2021</p>
                        </div>
                        <a
                          href={BADI_PDF_URL}
                          target="_blank"
                   ...
                   <div className="p-3 bg-[#f4ebd8]/50 border border-amber-900/20 hover:border-amber-900/50 transition-colors shadow-sm">
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                        <div>
                          ...
                          <p className="font-mono text-[10px] text-amber-900/70 mt-1">
                   ...
                   <div className="p-3 bg-[#f4ebd8]/50 border border-amber-900/20 hover:border-amber-900/50 transition-colors shadow-sm">
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                        <div>
                          ...
                          <p className="font-mono text-[10px] text-amber-900/70 mt-1">Archiwum: tribunydek.com</p>
                        </div>
                        <a
                   ...
                   <div className="p-3 bg-[#f4ebd8]/50 border border-amber-900/20 hover:border-amber-900/50 transition-colors shadow-sm">
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                        <div>
                          ...
                          <p className="font-mono text-[10px] text-amber-900/70 mt-1">Archiwum: munaysonqo.com (Peru)</p>
                        </div>
                        <a
                   ...
                   <div className="p-3 bg-[#f4ebd8]/50 border border-amber-900/20 border-l-red-900 border-l-4 hover:border-amber-900/50 transition-colors shadow-sm">
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-2">
                        <div>
                          ...
                          <p className="font-mono text-[10px] text-amber-900/70 mt-1 uppercase tracking-wider">Opublikowano: 3 marca 2026</p>
                        </div>
                        <div className="shrink-0 w-40 justify-center bg-[#dfd5b6]/50 text-amber-900/50 px-3 py-1 text-xs font-bold rounded border border-amber-900/10 flex items-center gap-2 cursor-default">
                          <span>🔗</span> Link nieaktywny
                        </div>
                      </div>
                      <div className="border-t border-amber-900/10 pt-2 text-[10px] text-amber-900/70 font-mono italic">
                 ...
                 <div className="mt-8 text-center pb-12">
                   <div className="w-24 h-[2px] bg-amber-900/30 mx-auto mb-6"></div>

                   <div className="mb-10 bg-amber-900/5 p-6 border border-amber-900/20 rounded-sm text-center">
                     <h3 className="text-sm font-bold text-amber-950 uppercase tracking-widest mb-4 flex items-center justify-center gap-2">
                     ...
                     <div className="grid gap-3 font-mono text-[10px] uppercase tracking-wider">
                       <a href="ipfs://bafybeicnxl_pelna_dokumentacja_wiedzmin_gate" className="text-amber-950 font-bold hover:bg-amber-900/10 px-2 py-1 rounded transition-colors underline decoration-red-800/40 decoration-double">IPFS: Baza Dowodowa (Full Archive)</a>
                       <a href="https://arweave.net/eliksir-wiedzmina-dokumentacja" className="text-amber-950 font-bold hover:bg-amber-900/10 px-2 py-1 rounded transition-colors underline decoration-red-800/40 decoration-double">Arweave: Trwała Archiwizacja</a>
                       <a href="https://github.com/detektyw-polutek/eliksir-mirror" className="text-amber-950 font-bold hover:bg-amber-900/10 px-2 py-1 rounded transition-colors underline decoration-red-800/40 decoration-double">GitHub: Source Mirror</a>
                     </div>
                   </div>

                   <p className="text-xs text-amber-900/80 font-mono uppercase tracking-widest mb-2 flex items-center justify-center gap-2">
                     <span>🌐</span>
                     Oficjalna Witryna
                   </p>
                   <a
                     ...
                     target="_blank"
                     rel="noopener noreferrer"
                     className="font-mono text-sm font-bold text-red-900 hover:text-red-950 hover:bg-amber-900/10 px-2 py-1 rounded transition-colors underline decoration-double decoration-red-800/40"
                   >
