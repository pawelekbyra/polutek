...
export default function Page() {
  ...
  return (
    <ElixirModalsProvider>
      ...
      <main className="min-h-screen paper-texture text-stone-900 selection:bg-stone-200 font-serif flex flex-col items-center">
        <BrandHeader />

        {/* Kontener artykułu w stylu gazety */}
        <div className="w-full max-w-5xl bg-transparent px-4 md:px-8 md:border-x border-stone-200 min-h-screen">

          <header className="pt-12 pb-12">
            <div className="text-center">
              <span className="inline-block text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] text-stone-400 mb-6 font-sans">
                Raport Specjalny • Śledztwo
              </span>
              <h1 className="mb-10 text-stone-900">
                <span className="block text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter uppercase font-sans">
                  Eliksir Wiedźmina
                </span>
                <span className="block text-2xl md:text-4xl text-stone-600 italic font-medium mt-8 max-w-3xl mx-auto leading-relaxed">
                  Mroczna tajemnica twórców CD Projekt
                </span>
              </h1>

              <div className="max-w-3xl mx-auto border-y border-stone-800 py-10 px-6">
                <p className="text-xl md:text-2xl text-stone-800 leading-relaxed italic font-bold">
          ...
          <article className="pt-8 pb-20">
            <div className="prose prose-stone prose-lg max-w-none prose-blockquote:not-italic
              prose-a:text-stone-900 prose-a:font-bold prose-a:no-underline prose-a:underline hover:prose-a:bg-stone-100 transition-colors
              text-justify-newspaper hyphens-auto">

              <p className="drop-cap text-xl md:text-2xl font-bold leading-relaxed text-stone-800 mb-12">
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Świadek B.</h2>

              <p>
                W obszernym i publicznie dostępnym uzasadnieniu <GalleryTrigger type="wyrok_kordys" className="font-bold text-stone-900 underline hover:bg-stone-100 transition-colors">wyroku</GalleryTrigger> Jarosława Kordysa pojawia się postać świadka Bartosza B.
              </p>
              ...
              <p>
                W Czechach księgi wieczyste są jawne i dostępne online. Wystarczy wejść na stronę Katastru Nieruchomości, wyszukać <GalleryTrigger type="janov" className="font-bold text-stone-900 underline hover:bg-stone-100 transition-colors">działkę w Janowie</GalleryTrigger> i za niewielką opłatą pobrać jej pełną historię.
              </p>
              ...
              Pobrany dokument nie pozostawia wątpliwości: w latach 2012–2023 współwłaścicielami nieruchomości byli:
                 ...
                 Bartosz Badowski (10%)
                 <br/>
                 <span className="bg-yellow-100 px-1 font-bold text-stone-900 box-decoration-clone">Michał Dawid Kiciński (90%)</span>
              </p>

              <p>
                Drugie imię – Dawid – idealnie wypełnia lukę w zanonimizowanym skrócie &quot;Michal D. K.&quot;. <span className="bg-yellow-100 px-1 font-bold text-stone-900 shadow-sm box-decoration-clone">Wspólnikiem szamana był twórca &quot;Wiedźmina&quot; – jeden z najbogatszych Polaków.</span>
              </p>

              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Na podsłuchu</h2>
              ...
              <CaseFile title="Rekonstrukcja rozmowy (Uzasadnienie Sądu)" type="transcript">
                &quot;oskarżony [Jarosław Kordys] omawia z&nbsp;B., że dotarła do niego informacja, że w obiekcie w Janowie <span className="underline decoration-red-600 decoration-4 underline-offset-4">zmarła jakaś kobieta</span>&quot;.
              </CaseFile>
              ...
              <div className="my-16 pl-8 border-l-4 border-stone-900 italic text-2xl text-stone-800">
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Cena wolności</h2>
              ...
              <div className="my-12 w-full rounded-sm overflow-hidden shadow-xl border border-stone-300 contrast-125 sepia-[0.1]">
                 <ArticleVideoPlayer
                    src={`${PINATA_GATEWAY}/${ARREST_VIDEO_CID}/videoplayback.m3u8`}
                    poster=""
                 />
              </div>
               <div className="mt-2 text-xs text-stone-500 font-sans border-l-2 border-stone-800 pl-4 mb-12 italic">
                   <span className="font-bold text-stone-900 uppercase text-[10px] mr-2">Archiwum:</span>
              ...
              <div className="my-12 flex gap-6 p-8 bg-stone-100 border border-stone-300 rounded-sm shadow-sm">
                <Scale className="w-10 h-10 text-stone-900 shrink-0" />
                <div>
                  <strong className="block font-sans text-stone-900 text-xl font-black mb-2 uppercase tracking-tight">Dohoda o vině a trestu</strong>
                  <div className="text-stone-800 text-lg leading-relaxed italic">
              ...
              <p>
                 Na mocy <GalleryTrigger type="wyrok_badi" className="font-bold text-stone-900 underline hover:bg-stone-100 transition-colors">wyroku</GalleryTrigger> z dnia 2 listopada 2021 roku Bartosz Badowski został uznany winnym popełnienia &quot;zbrodni niedozwolonej produkcji i innego obchodzenia się ze środkami odurzającymi&quot;.
              </p>
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Cisza po burzy</h2>
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Kiciński</h2>
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">&quot;Błąd z Badim&quot;</h2>
              ...
              <div className="my-12 flex flex-col items-center">
                <GalleryTrigger type="wezwanie_kicinski">
                  <img
                    ...
                    className="w-56 rounded-sm shadow-xl border border-stone-300 cursor-pointer hover:opacity-95 transition-opacity grayscale contrast-110"
                  />
                </GalleryTrigger>
                <p className="text-[10px] text-stone-500 mt-4 font-sans uppercase tracking-[0.2em] w-56 text-center italic">
                  Dowód nr 1: Skan wezwania (Powiększ)
                </p>
              </div>
              ...
              <CaseFile title="Odpowiedź na pytanie o udział">
                &quot;nie brałem udziału w takich ceremoniach w latach 2016-2023, a o wcześniejszym okresie <span className="underline decoration-stone-900 decoration-4 underline-offset-4 font-bold uppercase">odmawiam odpowiedzi</span>&quot;
              </CaseFile>
    ...
    <p>
      Co na to Bartosz Badowski?
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Anonimowy filantrop</h2>
              ...
              <CaseFile title="Wypowiedź K. Stefanka">
                &quot;Ostatecznie <span className="bg-yellow-100 px-1 font-bold box-decoration-clone">23 października 2023 roku</span> ten człowiek do nas zadzwonił powiedział, że wspólnie z żoną zdecydowali, że oni by chcieli to miejsce przekazać w darowiźnie&quot;
              </CaseFile>
              ...
              <div className="my-12 w-full rounded-sm overflow-hidden shadow-xl border border-stone-300 contrast-125 sepia-[0.1]">
               ...
               <div className="mt-2 text-xs text-stone-500 font-sans border-l-2 border-stone-800 pl-4 mb-12 italic">
                  <span className="font-bold text-stone-900 uppercase text-[10px] mr-2">Wideo:</span>
                  Krzysztof Stefanek opowiada o &quot;cudownym&quot; otrzymaniu darowizny (2025 r.)
                </div>
              ...
              <ul className="list-none space-y-12 my-12 font-mono text-[11px] md:text-xs border-l-2 border-stone-800 pl-6 uppercase tracking-widest text-stone-600">
                <li className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-stone-400 shrink-0" />
                  <div>
                    <span className="font-black text-stone-900">21 września 2023 r.</span><br/>
                ...
                <li className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-stone-400 shrink-0" />
                  <div>
                    <span className="font-black text-stone-900">3 października 2023 r.</span><br/>
                    Na tydzień przed wizytą na komendzie odkupuje od Bartosza Badowskiego jego 10% udziałów. Aby pozbyć się całego ośrodka jednym podpisem, musi najpierw stać się jego jedynym właścicielem.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-stone-400 shrink-0" />
                  <div>
                    <span className="font-black text-stone-900">11 października 2023 r.</span><br/>
                    Miliarder staje przed policją. Do protokołu odmawia zeznań na temat swojej przeszłości w tym miejscu.
                  </div>
                </li>

                <li className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-red-700 shrink-0 mt-3" />
                  <div className="bg-stone-100 border border-stone-800 p-6 rounded-sm shadow-md w-full relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-1.5 h-full bg-red-800"></div>
                    <span className="font-black text-red-900 text-sm">23 października 2023 r.</span><br/>
                ...
                <li className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-stone-400 shrink-0" />
                  <div>
                    <span className="font-black text-stone-900">21 grudnia 2023 r.</span><br/>
                    Finał operacji. Kiciński formalnie przekazuje Janov w formie darowizny. Nieruchomość trafia do stowarzyszenia &quot;non-profit&quot; – fasadowej organizacji zarządzanej przez lojalnych ludzi.
                  </div>
                </li>
              </ul>
              ...
              <div className="my-10 flex justify-start">
                 <TransactionStampUI
                  label="Rejestr Transakcji"
                  value="V-5821/2023-127"
                  subDetails="Janov u Krnova | LV 127"
                />
              </div>
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Nýdek</h2>
              ...
              <p>
                <span className="bg-yellow-100 px-1 font-bold text-stone-900 shadow-sm">Oznacza to, że nie jeden lecz obaj legendarni założyciele CD Projekt, na czeskim pograniczu posiadali nieruchomości, w których odpłatnie oferowano te same nielegalne substancje.</span>
              </p>
              ...
              <ul className="list-none space-y-12 my-12 font-mono text-[11px] md:text-xs border-l-2 border-stone-800 pl-6 uppercase tracking-widest text-stone-600">
                 <li className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-stone-400 shrink-0" />
                  <div>
                    <span className="font-black text-stone-900">15 października 2020 r.</span><br/>
                ...
                <li className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-stone-400 shrink-0" />
                  <div>
                    <span className="font-black text-stone-900">15 czerwca 2021 r.</span><br/>
              ...
              <h2 className="text-4xl mt-20 mb-10 tracking-tighter text-stone-900 border-b-2 border-stone-800 pb-4 font-sans font-black uppercase">Wiktor B.</h2>
              ...
              <div className="mt-16 mb-6 flex justify-end">
                 <div className="text-right border-t-2 border-stone-800 pt-4">
                    <span className="block font-black text-stone-900 uppercase tracking-tighter text-xl">Detektyw Polutek</span>
                    <span className="block text-[10px] text-stone-500 font-sans mt-1 italic uppercase tracking-widest">detektyw.polutek@protonmail.com</span>
                 </div>
              </div>

              <div className="my-16 border-y-4 border-double border-black py-12">
                 <h3 className="font-sans font-black text-xl uppercase tracking-[0.3em] text-stone-900 mb-10 flex items-center justify-center gap-4">
                    <ShieldCheck className="w-6 h-6" />
                    Status Prawny
                 </h3>

                 <div className="grid gap-px bg-stone-300 border border-stone-300 shadow-sm">
                    <div className="bg-[#fdfbf7] p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                       <div>
                          <span className="block font-sans text-stone-900 font-black uppercase tracking-tight text-lg">Organizacja ceremonii</span>
                          <span className="block text-[10px] text-stone-500 mt-1 font-sans uppercase tracking-widest">Prokuratura Rejonowa w Częstochowie</span>
                       </div>
                       <span className="font-mono text-xs font-bold bg-stone-100 px-4 py-2 border border-stone-800 text-stone-900 rounded-none shadow-sm whitespace-nowrap">
                          3013-1.Ds.15.2024
                       </span>
                    </div>
                    ...
                    <div className="bg-[#fdfbf7] p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                       <div>
                          <span className="block font-sans text-stone-900 font-black uppercase tracking-tight text-lg">Śmierć Ilony Lewandowskiej</span>
                          <span className="block text-[10px] text-stone-500 mt-1 font-sans uppercase tracking-widest">Prokuratura Rejonowa w Częstochowie</span>
                       </div>
                       <span className="font-mono text-xs font-bold bg-red-50 px-4 py-2 border border-red-800 text-red-900 rounded-none shadow-sm whitespace-nowrap">
                          3013-1.Ds.4.2026
                       </span>
                    </div>
                    ...
                    <div className="bg-[#fdfbf7] p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                       <div>
                          <span className="block font-sans text-stone-900 font-black uppercase tracking-tight text-lg">Śmierć Wiktora B.</span>
                          <span className="block text-[10px] text-stone-500 mt-1 font-sans uppercase tracking-widest">Prokuratura Rejonowa w Pułtusku</span>
                       </div>
                       <div className="flex flex-col items-end gap-2">
                          <span className="font-mono text-xs font-bold bg-stone-100 px-4 py-2 border border-stone-800 text-stone-900 rounded-none shadow-sm whitespace-nowrap">
                            4027-0. Ds. 1254.2024
                          </span>
                          <span className="text-[10px] font-sans font-black text-red-700 uppercase tracking-tighter bg-red-50 px-2 py-0.5">Zawieszone</span>
                       </div>
                    </div>
                 </div>

                 <div className="mt-10 text-[11px] text-stone-500 font-sans text-center leading-relaxed italic max-w-2xl mx-auto">
            ...
            <footer className="mt-10 pt-10 border-t border-stone-800 font-sans">

               <div className="mb-10 text-center">
                 <h3 className="text-2xl font-black text-stone-900 uppercase tracking-[0.4em] flex items-center justify-center gap-4 mb-6">
                   <Search className="w-6 h-6" /> Dokumentacja
                 </h3>
                 <p className="text-sm text-stone-600 italic max-w-2xl mx-auto leading-relaxed">
                   Artykuł powstał na podstawie jawnej dokumentacji urzędowej i sądowej. Poniżej lista sygnatur oraz odnośniki do baz państwowych, umożliwiające niezależną weryfikację.
                 </p>
               </div>

               <div className="grid gap-6 md:grid-cols-2 text-sm text-stone-700">

                 <div className="p-5 bg-white border border-stone-300 hover:border-stone-800 transition-all shadow-sm rounded-none">
                    <div className="flex flex-col justify-between h-full gap-4">
                      <div>
                        <h4 className="font-black text-stone-900 text-base leading-tight uppercase tracking-tight">Wyrok: <strong>Jarosława Kordysa</strong></h4>
                        <p className="font-mono text-[10px] text-stone-400 mt-2 uppercase">Sygn. 30 T 5/2020</p>
                      </div>
                      <div className="flex flex-col gap-3">
                        <a
                          ...
                          className="w-full text-center bg-stone-900 text-white px-4 py-2 text-xs font-bold uppercase tracking-widest hover:bg-stone-800 transition-colors flex items-center justify-center gap-2"
                        >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[9px] text-stone-400 hover:text-stone-900 flex items-center justify-center gap-1 uppercase tracking-widest transition-colors"
                        >
                          <Globe className="w-3 h-3" />
                          Weryfikuj (msp.gov.cz)
                        </a>
                      </div>
                    </div>
                 </div>
                 ...
                 <div className="p-5 bg-white border border-stone-300 hover:border-stone-800 transition-all shadow-sm rounded-none">
                    <div className="flex flex-col justify-between h-full gap-4">
                      <div>
                        <h4 className="font-black text-stone-900 text-base leading-tight uppercase tracking-tight">Wyrok: <strong>Bartosza Badowskiego</strong></h4>
                        <p className="font-mono text-[10px] text-stone-400 mt-2 uppercase">Sygn. 66 T 146/2021</p>
                      </div>
                      <div className="flex flex-col gap-3">
                        <a
                          href={BADI_PDF_URL}
                 ...
                 <div className="p-5 bg-white border border-stone-300 hover:border-stone-800 transition-all shadow-sm rounded-none">
                    <div className="flex flex-col justify-between h-full gap-4">
                      <div>
                        <h4 className="font-black text-stone-900 text-base leading-tight uppercase tracking-tight">Katastr: <strong>Janov</strong></h4>
                        <p className="font-mono text-[10px] text-stone-400 mt-2 uppercase">LV 127 | Obręb 656976</p>
                      </div>
                      <div className="flex flex-col gap-3">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-full text-center border-2 border-stone-900 text-stone-900 px-4 py-2 text-xs font-bold uppercase tracking-widest hover:bg-stone-50 transition-colors flex items-center justify-center gap-2"
                        >
                          <Globe className="w-4 h-4" /> Weryfikuj online
                        </a>
                      </div>
                    </div>
                 </div>
                 ...
                 <div className="p-5 bg-white border border-stone-300 hover:border-stone-800 transition-all shadow-sm rounded-none">
                    <div className="flex flex-col justify-between h-full gap-4">
                      <div>
                        <h4 className="font-black text-stone-900 text-base leading-tight uppercase tracking-tight">Katastr: <strong>Nýdek</strong></h4>
                        <p className="font-mono text-[10px] text-stone-400 mt-2 uppercase">LV 832 | Obręb 708186</p>
                      </div>
                      <div className="flex flex-col gap-3">
                        <a
                          href="https://nahlizenidokn.cuzk.cz"
               ...
               <div className="mt-20 text-center pb-20">
                  <div className="w-32 h-1 bg-stone-900 mx-auto mb-10"></div>

                  <div className="mb-16 bg-stone-50 p-10 border-2 border-stone-900 rounded-none text-center shadow-lg relative">
                    <div className="absolute top-4 left-4">
                      <ShieldCheck className="w-6 h-6 text-stone-400" />
                    </div>
                    <h3 className="text-lg font-black text-stone-900 uppercase tracking-[0.3em] mb-6 flex items-center justify-center gap-4">
                      Zaszyfrowany Mirror
                    </h3>
                    <p className="text-xs text-stone-600 mb-8 leading-relaxed font-sans max-w-xl mx-auto italic">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 font-mono text-[9px] uppercase tracking-widest font-black">
                      <a href="ipfs://bafybeicnxl_pelna_dokumentacja_wiedzmin_gate" className="text-stone-900 hover:underline">IPFS: Baza Dowodowa</a>
                      <a href="https://arweave.net/eliksir-wiedzmina-dokumentacja" className="text-stone-900 hover:underline">Arweave: Archiwum</a>
                      <a href="https://github.com/detektyw-polutek/eliksir-mirror" className="text-stone-900 hover:underline">GitHub Source</a>
                    </div>
                  </div>

                  <p className="text-[10px] text-stone-400 font-sans uppercase tracking-[0.5em] mb-4">
                    Domena Oficjalna
                  </p>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-lg text-stone-900 hover:italic transition-all uppercase tracking-tighter font-black"
                  >
