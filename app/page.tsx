  ...
  return (
    <main className="min-h-screen bg-[#FDFBF7] text-[#1a1a1a] selection:bg-yellow-200/50 font-serif">
      ...
      <article className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="mt-20 mb-16 p-8 bg-stone-100 border border-stone-200 text-center rounded-sm">
          <div className="flex justify-center mb-6">
            <div className="p-4 bg-white rounded-full border border-stone-200 shadow-sm">
              <User className="w-10 h-10 text-stone-700" />
            </div>
          </div>
          <h3 className="font-serif text-2xl text-stone-900 mb-2">Detektyw Polutek</h3>
          <p className="font-sans text-stone-500 uppercase tracking-widest text-xs mb-6">Dziennikarz Śledczy &bull; Niezależne Media</p>
          
          <div className="w-16 h-px bg-stone-300 mx-auto mb-6"></div>

          <p className="text-stone-700 italic mb-8 max-w-lg mx-auto leading-relaxed">
          ...
          <a href="mailto:detektyw.polutek@protonmail.com" className="inline-flex items-center gap-2 px-6 py-3 bg-stone-900 text-white hover:bg-stone-800 transition-colors rounded-sm text-sm tracking-wide uppercase">
        ...
        <footer className="mt-12 pt-12 border-t-2 border-stone-200 font-sans">
          ...
          <div className="grid gap-4 text-sm text-stone-600">
            ...
            <div className="p-4 bg-white border border-stone-200 hover:border-blue-300 transition-colors shadow-sm">
              ...
              <p className="mb-2">Zrzuty strony ośrodka w Nýdku (2016-2021). <br/> <span className="text-stone-400 text-xs uppercase">Instrukcja:</span> Wejdź na archive.org i wpisz "tribunydek.com" w wyszukiwarkę.</p>
