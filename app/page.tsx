...
const KORDYS_PDF_URL = `${PINATA_G
                          
                          ATEWAY}/bafybeibzxfsg5s4jkiuf2kzmbdtmfutfjk75ej5zrpt2igan4aldvqc3oq`;
    ...
    <>
      ...
      <main className="min-h-screen bg-transparent text-[#000000] selection:bg-[#e8d154]/50 font-body flex flex-col items-center relative">
        ...
        >
         ...
         <div 
  className="article-prose font-serif text-lg leading-relaxed" 
...
<p className="mt-2">
  <span className="bg-red-600 px-1 font-black text-white shadow-sm box-decoration-clone">
    Wspólnikiem szamana był twórca Wiedźmina – jeden z najbogatszych Polaków.
              ...
              <p className="mt-4">
                3 marca 2026 Onet ujawnia opinii publicznej wstrząsające kulisy działalności ośrodka w czeskim Janowie, gdzie podczas szamańskiej ceremonii z użyciem ayahuaski miało dojść do tragicznych zdarzeń. Dziennikarskie śledztwo koncentruje się na śmierci 54-letniej uczestniczki, Ilony L.-H.
              </p>
              ...
              <p className="mt-4">
                Sytuacja uległa diametralnej zmianie 6 maja 2024 roku, gdy Prokuratura Okręgowa w Częstochowie wszczęła oficjalne śledztwo w sprawie działalności ośrodka oraz okoliczności śmierci Ilony L.-H. Zaledwie 2 miesiące  później, w tajemniczych okolicznościach umiera Wiktor B.
              </p>
