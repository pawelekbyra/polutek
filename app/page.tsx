...
export const KORDYS_IMAGES_URL = "/gallery/wyrok_kordysa";
export const BADI_IMAGES_URL = "/gallery/wyrok_badi";
export const NYDEK_IMAGES_URL = "/gallery/nydek";
export const JANOV_IMAGES_URL = "/gallery/janov";
